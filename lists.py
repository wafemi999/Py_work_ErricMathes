...
print("friend number one name is: ", names[1].title())
print("friend number one name is: ", names[2].title())
print("friend number one name is: ", names[-1].upper())
print("friend number one name is: ", names[3].upper())

#exercises on list(3-3)
